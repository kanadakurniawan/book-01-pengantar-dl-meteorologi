...
> Daftar pustaka agregat ini menggabungkan seluruh referensi yang dipakai di
> Bab 1–10 (sumber: `refs.bib` tiap bab). Di tiap bab, referensi juga
> dicantumkan per-bab (format IEEE, nomor mengikuti kemunculan pertama).
> Standar sitasi dan hierarki prioritas sumber mengikuti `outline.md` →
> "Kriteria Sitasi" (IEEE; DOI wajib bila tersedia; URL hanya bila tanpa DOI,
...
7. F. Rosenblatt, "The perceptron: A probabilistic model for information storage and organization in the brain," *Psychological Review*, vol. 65, no. 6, pp. 386–408, 1958. doi: 10.1037/h0042519.
8. D. E. Rumelhart, G. E. Hinton, and R. J. Williams, "Learning representations by back-propagating errors," *Nature*, vol. 323, no. 6088, pp. 533–536, 1986. doi: 10.1038/323533a0.
9. Y. LeCun, Y. Bengio, and G. Hinton, "Deep learning," *Nature*, vol. 521, no. 7553, pp. 436–444, 2015. doi: 10.1038/nature14539.
10. M. Reichstein et al., "Deep learning and process understanding for data-driven Earth system science," *Nature*, vol. 566, no. 7743, pp. 195–204, 2019. doi: 10.1038/s41586-019-0912-1.
...
20. C. Funk et al., "The climate hazards infrared precipitation with stations—a new environmental record for monitoring extremes," *Scientific Data*, vol. 2, Art. no. 150066, 2015. doi: 10.1038/sdata.2015.66.
21. S. J. Holgate et al., "New data systems and products at the Permanent Service for Mean Sea Level," *Journal of Coastal Research*, vol. 29, no. 3, pp. 477–479, 2013. doi: 10.2112/JCOASTRES-D-12-00175.1.
22. S. Rasp et al., "WeatherBench: A benchmark data set for data-driven weather forecasting," *Journal of Advances in Modeling Earth Systems*, vol. 12, no. 10, Art. no. e2020MS002203, 2020. doi: 10.1029/2020MS002203.
...
27. D. Sculley et al., "Hidden technical debt in machine learning systems," in *Proc. Advances in Neural Information Processing Systems (NeurIPS)*, 2015, pp. 2503–2511.
28. Y. Gal and Z. Ghahramani, "Dropout as a Bayesian approximation: Representing model uncertainty in deep learning," in *Proc. Int. Conf. Machine Learning (ICML)*, 2016, pp. 1050–1059. (Preprint: arXiv:1506.02142.)
29. C. Guo, G. Pleiss, Y. Sun, and K. Q. Weinberger, "On calibration of modern neural networks," in *Proc. Int. Conf. Machine Learning (ICML)*, ser. PMLR, vol. 70, 2017, pp. 1321–1330. (Preprint: arXiv:1706.04596.)
...
> **Catatan verifikasi:** sebelum *release* final, seluruh DOI di atas diuji
> ulang melalui `doi.org/<doi>`; entri web diverifikasi tanggal aksesnya. Untuk
> daftar *per bab* (bernomor sesuai kemunculan), lihat bagian "Referensi" pada
> akhir masing-masing bab atau `refs.bib` di `manuscripts/ch-<NN>-*/`.